...
export default function Footer({ posts }: Props) {
  ...
  return (
    <footer className="bg-[#0066cc] text-white font-sans">
      ...
      {/* Main 4-column grid */}
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-b border-white/[0.06] ">
        {/* Navigate */}
        <div className="px-6 md:px-10 py-8 border-r border-white/[0.05] font-serif text-white-100">
